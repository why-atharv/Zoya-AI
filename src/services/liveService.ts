...
export class LiveSessionManager {
  ...
  private preferredTitle: string;

  constructor(creatorName: string = "Atharv", preferredTitle: string = "Sir") {
  ...
  async start() {
    try {
      ...
      const instruction = getSystemInstruction(this.creatorName, this.preferredTitle);
      ...
      this.sessionPromise = this.ai.live.connect({
        model: "gemini-3.1-flash-live-preview", // Updated to supported live model
        config: {
